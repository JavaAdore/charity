...
@ManagedBean
@ApplicationScoped
public class SystemUserGroupConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component,
            String value) {
          Roles systemUserGroup  = null;
        if(Utils.isNotEmpty(value)&&Utils.isNumber(value))
        {
             systemUserGroup  = (Roles)webAppFacade.getRole(Long.valueOf(value));
        }
    ...
    public String getAsString(FacesContext context, UIComponent component,
		...
		if(value !=null && value instanceof Roles )
                {
                 Roles objectToConvert =    (Roles) value;
